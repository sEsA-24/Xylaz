...
const TopDoctors = () => {
    ...
    return (
        <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10 mt-20" id="topdoctors">
            <h1 className="text-3xl font-medium mt-5">Barbers to Book</h1>
            <p className="sm:w-1/3 text-center text-sm">
                Simply browse through our extensive list of skilled barbers.
            </p>
